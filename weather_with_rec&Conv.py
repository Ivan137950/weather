...
# make a model small and than add GRU layer
...
plt.legend()
plt.show()  #MAE << than if we used more simple net




# recurrent dropout can help very match!
# we can although add several layers . it will help a bit too